...
class LogMelExtractor:
    def __init__(self, sample_rate=16000, n_fft=256, n_mels=64, 
    ...
    def extract(self, audio):
        ...
        #OLD: 
        #   - normalize to [-1, 1]                                                                                             
        #51 - audio_tensor = torch.from_numpy(audio.astype(np.float32)) / 32768.0  

        # Keep int16 scale to match RTL pipeline (no normalization)
