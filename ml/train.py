...
def main():
    ...
    feature_extractor = LogMelExtractor(
        ...
        n_fft=preproc_cfg["n_fft"],
        n_mels=preproc_cfg["n_mels"],
        hop_length=preproc_cfg["hop_length"],
        window_length=preproc_cfg.get("window_length", 512),
    )
    
    # Create dataloaders
    print("\nCreating dataloaders...")
    train_loader, val_loader, test_loader = create_dataloaders(config, feature_extractor)
