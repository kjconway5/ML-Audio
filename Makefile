...
librelane-condensed: ## Run LibreLane flow condensed (for CI)
	librelane librelane/slots/slot_${SLOT}.yaml librelane/config.yaml --condensed --save-views-to $(MAKEFILE_DIR)/final --pdk ${PDK} --pdk-root ${PDK_ROOT} --scl ${SCL} --manual-pdk
