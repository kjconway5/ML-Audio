...
SCL_REPO = https://github.com/AvalonSemiconductors/gf180mcu_as_sc_mcu7t3v3.git
...
install-3v3-scl-hotfix: $(PDK_ROOT)/ciel/gf180mcu/versions/$(PDK_COMMIT)/$(PDK) ## Apply SCL hotfix
	rm -rf $(MAKEFILE_DIR)/gf180mcu_as_sc_mcu7t3v3_hotfix
	git clone --depth 1 $(SCL_REPO) $(MAKEFILE_DIR)/gf180mcu_as_sc_mcu7t3v3_hotfix
	cp -r $(MAKEFILE_DIR)/gf180mcu_as_sc_mcu7t3v3_hotfix/pdk/libs.ref/. $(PDK_ROOT)/$(PDK)/libs.ref/
	cp -r $(MAKEFILE_DIR)/gf180mcu_as_sc_mcu7t3v3_hotfix/pdk/libs.tech/. $(PDK_ROOT)/$(PDK)/libs.tech/
	rm -rf $(MAKEFILE_DIR)/gf180mcu_as_sc_mcu7t3v3_hotfix
.PHONY: install-3v3-scl-hotfix

clone-pdk: $(PDK_ROOT)/ciel/gf180mcu/versions/$(PDK_COMMIT)/$(PDK) $(SRAM_DIR) install-3v3-scl-hotfix ## Clone the GF180MCU PDK
.PHONY: clone-pdk
