...
dict set ::env(LIB) *_tt_025C_3v30 "\
    ...
    [glob $::env(PDK_ROOT)/$::env(PDK)/libs.ref/gf180mcu_fd_io/lib/*__tt_025C_3v30.lib]\
    $::env(PDK_ROOT)/$::env(PDK)/libs.ref/gf180mcu_fd_io/lib/gf180mcu_ws_io__tt_025C_5v00.lib\
"
dict set ::env(LIB) *_ff_n40C_3v60 "\
    ...
    [glob $::env(PDK_ROOT)/$::env(PDK)/libs.ref/gf180mcu_fd_io/lib/*__ff_n40C_3v63.lib]\
    $::env(PDK_ROOT)/$::env(PDK)/libs.ref/gf180mcu_fd_io/lib/gf180mcu_ws_io__ff_n40C_5v50.lib\
"
